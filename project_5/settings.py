...
MEDIA_URL = cloudinary.utils.cloudinary_url('media/')[0]
...
REST_AUTH = {
    "USER_DETAILS_SERIALIZER": "project_5.serializers.CurrentUserSerializer",
    "TOKEN_SERIALIZER": "project_5.serializers.CustomTokenSerializer",
    "USE_JWT": True,
